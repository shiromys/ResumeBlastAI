...
def get_incomplete_profiles():
    ...
    try:
        ...
        # PAID = has a COMPLETED payment only. Campaign existence does NOT imply
        # payment (guest shells, manual rescues, and stuck 'initiated' payments
        # can create campaign rows without a completed payment).
